#!/usr/bin/env bash
echo "***Actualizando e instalando paquetes vm1"
#apt-get update && apt-get upgrade -y

echo "***Instalando lxd 4.0 vm1"
snap install lxd --channel=4.0/stable
newgrp lxd

echo "***Inicializando nodo vm1"
cat > /home/vagrant/preseed.yaml <<EOF
config:
  core.https_address: 192.168.100.121:8443
...
lxc config device add haproxy puertohaproxy5085 proxy listen=tcp:192.168.100.121:5085 connect=tcp:127.0.0.1:80